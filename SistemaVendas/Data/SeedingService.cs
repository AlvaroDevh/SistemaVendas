...
namespace SistemaVendas.Data {
    public class SeedingService {
        ...
        public void Seed() {
            ...
            Departament d2 = new Departament("Eletrônicos ");
            ...
            Seller s1 = new Seller("Marcos Paulo", "marcos@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);

            Seller s2 = new Seller("Maria Tereza", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);

            Seller s3 = new Seller("Alex Silva", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);

            Seller s4 = new Seller("Ana Julia", "ana@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);

            Seller s5 = new Seller("Luiz Carlos", "luiz@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);

            Seller s6 = new Seller("Luciana Costa", "luciana@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
